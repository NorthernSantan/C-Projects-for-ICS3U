...
coordsFromUser := GetCoordinatePairInput; // This is the function that gets the input
//Write(WriteCoordinate(coordsFromUser[1]));  // This is the procedure that organizes the coordinates individuly}
Write (CoordinatePairToString(coordsFromUser));  // This procedure will output double the first procedure[ {1,1}, {2,2} ]
Writeln;
